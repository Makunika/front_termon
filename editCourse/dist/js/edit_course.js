...
function editCourse() {
    ...
    function tabsInit() {
        ...
        let currentContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.show_block');

        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tabs_link:not(:last)').each(function(index) {
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).unbind('click');
            jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).click(function(e) {
                if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).hasClass('active_link')) {
                    ...
                    jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.tabs_content`).eq(index)
                        .addClass('show_block').removeClass('hide');
                    currentContent = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.tabs_content`).eq(index);
                }
            });
        });
    }
    ...
    function showAddTab(e) {
        ...
        input.keyup(function(e) {
            inputValue = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).val();
    ...
    function saveNewTab(value, target) {
        if (value != "") {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tabs_contents').append(
                                /*html*/
                                `
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tabs_link:last').click(showAddTab);
